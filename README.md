...
| **小学生** | ✅ 4/4 | ✅ 4/4 | ✅ 4/4 |
| **中学生** | ✅ 4/4 | ✅ 4/4 | ✅ 4/4 |
| **高校生** | ✅ 4/4 (MD) | ✅ 4/4 (MD) | ✅ 4/4 (MD) |
| **高齢者** | ✅ 4/4 | ✅ 4/4 | ✅ 4/4 |

- 既存9コース (36回)：`lesson.md` + `interactive.html` の 2形式
- 高校生3コース (12回)：`lesson.md` のみ（`interactive.html` は 後追い実装）
- **合計：48回 × lesson.md ＋ 36回 × interactive.html = 84ファイル**
...
- 🎥 各回の **デモ動画**（30秒）を作成
- 🌍 **英語版** の作成
- 🖥️ 高校生コース の **interactive.html** 後追い実装（現在 MD のみ）
- 📦 **パッケージング / 配布**（コース別 ZIP）
